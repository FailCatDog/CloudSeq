<template>
  <section class="team-page">
    <div v-if="loading" class="team-panel team-panel--empty">
      <div>
    ...
    <div v-else-if="!hasTeam" class="team-panel team-panel--empty">
      <div>
    ...
    <div v-else class="team-layout">
      <section class="team-panel team-panel--main">
    ...
    <section v-if="hasTeam" class="team-panel">
      <div class="panel-head">
        <div>
    ...
    <teleport to="body">
      <div v-if="topicDialogVisible" class="dialog-mask" @click.self="closeTopicDialog">
        <div class="dialog-panel app-scrollbar">
          ...
          <label class="field">
            <span>选题标题</span>
            <input v-model.trim="topicForm.topicTitle" type="text" placeholder="输入选题标题" />
          </label>

          <label class="field">
            <span>选题说明</span>
            <textarea v-model.trim="topicForm.topicDesc" rows="4" placeholder="补充选题背景与计划"></textarea>
          </label>
    ...
    <section v-if="!hasTeam" class="team-panel">
      ...
      <form class="create-form" @submit.prevent="handleCreateTeam">
        <label class="field">
          <span>小组名称</span>
          <input v-model.trim="form.teamName" type="text" placeholder="请输入小组名称" />
        </label>
...
.team-panel {
  border: 1px solid rgba(124, 139, 166, 0.16);
  background: rgba(255, 255, 255, 0.92);
  box-shadow: 0 18px 48px rgba(18, 28, 45, 0.06);
}
